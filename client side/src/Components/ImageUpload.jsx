...
export default function ImageUpload () {
    ...
    return (
        <div className="flex justify-center w-full h-full relative aspect-square">
            ...
            {!file && !previewPhotoUrl && <button className="flex justify-center items-center w-full h-full z-10" onClick={(e) => selectFileHandler(e)}>
                <p className="text-center">Select an image</p>
            </button>}
