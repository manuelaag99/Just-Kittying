        ...
        <div>
            ...
            <div className="flex flex-col fixed justify-center items-center z-50 top-[10%] sm:left-[25%] left-[5%] sm:w-5/10 w-9/10 h-7/10 bg-var-1 rounded-button  text-signInOrsignUpMob sm:text-signInOrsignUpDsk duration-500">
                ...
                <div className="w-8/10 h-fit mt-4">
                    ...
                    <button disabled={!stateOfForm.isFormValid} className="disabled:bg-var-2 disabled:cursor-pointer w-full py-2 px-2 mb-4 rounded-input bg-black text-var-1 border-black border-solid border-2 hover:bg-var-3 hover:border-var-3 duration-500 ">Sign in</button>
